...
Reanuda a un conductor Gammavet y reclama la parada indicada
...
- The function name matches "ReanudarRutaFn"
...
- AWS CloudWatch Logs: `/aws/lambda/ReanudarRutaFn`
- Chask dashboard: Organization → Functions → ReanudarRutaFn
